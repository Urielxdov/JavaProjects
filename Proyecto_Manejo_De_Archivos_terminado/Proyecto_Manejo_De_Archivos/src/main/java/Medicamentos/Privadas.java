...
public class Privadas extends Medicamento {
    String ruta, fechaDeCaducidad, tipoMedicamento;
    int existencia, surtidos, existenciaTotal;

    public Privadas(int clave, int folio, String nombreMedicamento, int existencia, int surtidos, int existenciaTotal, String fechaDeCaducidad) {
        super(clave, folio, nombreMedicamento);
        this.existencia = existencia;
        this.surtidos = surtidos;
        this.existenciaTotal = existenciaTotal;
        this.fechaDeCaducidad = fechaDeCaducidad;
        this.tipoMedicamento = "Privada";
    }
